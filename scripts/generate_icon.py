...
def make_icon(size: int = 128) -> bytes:
    ...
    # Markdown bars
    put_rect(38, 52, 26, 5, (30, 85, 190, 255))
    put_rect(38, 61, 20, 5, (30, 85, 190, 255))
    put_rect(38, 70, 24, 5, (30, 85, 190, 255))

    # View glyph
    put_rect(64, 58, 24, 10, (45, 89, 189, 255))
    put_rect(70, 61, 12, 4, (247, 251, 255, 255))
    put_rect(74, 61, 4, 4, (45, 89, 189, 255))
