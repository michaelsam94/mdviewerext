...
def main() -> None:
    ...
    put_rect(pixels, width, 160, 240, 140, 18, (30, 85, 190, 255))
    put_rect(pixels, width, 160, 280, 120, 18, (30, 85, 190, 255))
    put_rect(pixels, width, 160, 320, 130, 18, (30, 85, 190, 255))

    # Eye motif
    put_rect(pixels, width, 270, 360, 120, 70, (45, 89, 189, 255))
    put_rect(pixels, width, 300, 384, 60, 20, (247, 251, 255, 255))
    put_rect(pixels, width, 323, 389, 14, 10, (45, 89, 189, 255))

    out = Path("mdviewerext-banner.png")
